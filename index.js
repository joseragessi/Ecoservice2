...
const {
  ...
  _esListadoCompleto: esListadoCompletoStock
} = require('./stock');
    ...
    try {
      ...
      if (
        ...
        if (
          ...
          // Se le pidió el stock y todavía no contestó. La plantilla de
          // WhatsApp no puede llevar el listado adentro, así que la respuesta
          // —sea la que sea— es lo que abre la ventana: acá se le manda el
          // listado para confirmar.
          //
          // Solo se procesa como listado si es COMPLETO (5+ renglones o texto
          // largo). Con `pareceListadoStock` —criterio más flojo— un reporte
          // como "se rompió la motoguadaña 12" pisaba el censo del objetivo:
          // así se perdió el censo de UCC el 04-sep.

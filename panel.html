...
<div id="app">
  <aside class="rail">
    ...
    <nav class="nav" id="nav">
      ...
      <div class="nav-item" data-v="bateas" onclick="go('bateas')">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M3 8h18l-2 11a2 2 0 01-2 2H7a2 2 0 01-2-2L3 8z"/><path d="M3 8l2-4h14l2 4M9 12v5M15 12v5"/></svg>Bateas</div>
